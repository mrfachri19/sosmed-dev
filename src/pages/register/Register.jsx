...
import loginBackground from "../../assets/image/loginimage.jpg";
import logodiarium from "../../assets/image/logodiarium.png";
import logogoogle from "../../assets/icon/icons8-google.svg";
import { Link } from "react-router-dom";
function Register() {
  return (
    <div className="2xl:container h-screen m-auto">
      <div hidden className="fixed inset-0 w-8/12 lg:block">
        {/* <Link to="https://www.telkom.co.id/sites"> */}
        <span className="absolute left-6 bottom-6 text-sm">
          Stay connected with your coworkers within Telkomgroup
        </span>
        {/* </Link> */}
      ...
      <div
        hidden
        role="hidden"
        className="fixed inset-0 w-5/12 ml-auto bg-white bg-opacity-70 backdrop-blur-xl lg:block"
      ></div>
      <div className="relative h-full ml-auto lg:w-6/12">
        <div className="m-auto py-12 px-6 sm:p-20 xl:w-10/12">
          <div className="space-y-4">
            {/* <Link to=""> */}
            <img src={logodiarium} className="w-40" alt="diarium logo" />
            {/* </Link> */}
            {/* <p className="font-medium text-lg text-red-600">Welcome Back</p> */}
          </div>

          <div className="mt-12 grid gap-6 sm:grid-cols-2">
            <button className="py-3 px-6 rounded-xl bg-blue-50 hover:bg-blue-100 focus:bg-blue-100 active:bg-blue-200">
              <div className="flex gap-4 justify-center">
                <img src={logogoogle} className="w-5" alt="" />
          ...
          <form action="" className="space-y-6 py-6">
            ...
            <div>
              ...
              {/* <Link to="#" type="reset" className="w-max p-3 -ml-3"> */}
